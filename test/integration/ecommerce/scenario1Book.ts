...
export function runScenario(ctx: ScenarioContext): void {
  ...
  describe('Phase A: Developer', () => {
    ...
    it('A1: creates feature/book branch', async function () {
      this.timeout(180000);
  ...
  describe('Phase B: PR workflow', function () {
    ...
    it('B1: creates PR', async () => {
      prNumber = await createPR(ctx, 'Add book entity with CRUD', BRANCH);
    ...
    it('B3: PR comment contains schema diff showing book table', async () => {
  ...
  describe('Phase D: Verification', function () {
    ...
    it('D2: book table exists on base branch', async () => {
