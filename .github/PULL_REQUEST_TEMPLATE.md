...
- [ ] **Tier 2 — Hermetic substrate BDD**: `(cd node_modules/@databricks-solutions/lakebase-scm-workflow-scripts && npx vitest run)` → all green
...
- [ ] Substrate dep bumped (`@databricks-solutions/lakebase-scm-workflow-scripts` SHA/tag)
